...
if(!filter_input(INPUT_GET, "NIF", FILTER_SANITIZE_STRING)) {
    echo "NIF é inválido!";
} else {
...
?>
    ...
    <div class="container" style="margin-top: 1.4rem;">
        ...
        <div class="card bg-light">
            <div class="card-body">
                <form action="/Api/usuarios/excluir.php" method="post">
                    <input type="hidden" name="NIF" value="<?php echo $NIF ?>">
                    <div class="form-group mb-3">
                        <label>NIF</label>
                        <input type="text" class="form-control"
                        value="<?php echo $linha["NIF"]; ?>" disabled>
                    </div>
                    ...
                    <a href="/views/usuarios/visualizar.php"><button class="btn btn-secondary btn-lg" type="button">Voltar</button></a>
