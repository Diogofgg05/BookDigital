...
<head>
    ...
    <style>
        ...
        /* Grid de Livros - Estilo Melhorado para Cliente */
        .books-grid {
            display: grid;
...
<body>
    <div class="page-container">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">Explore todos os livros disponíveis na biblioteca</p>
        </div>
        ...
        <?php
            ...
            // Função para converter ano em formato de data
        ...
        <div class="filters-container">
            <div class="filter-group">
                <select class="filter-select" id="filterGenero">
                    <option value="">Todos os Gêneros</option>
                    <?php
                    $generos = array_unique(array_column($resultado, 'GENERO'));
                ...
                <select class="filter-select" id="filterIdioma">
                    ...
                    <?php
                    $idiomas = array_unique(array_column($resultado, 'IDIOMA'));
        ...
        <?php if($resultado) { ?>
            ...
            <div class="books-grid" id="booksGrid">
                ...
                <div class="book-card" data-book-isbn="<?php echo $ISBN; ?>" 
                     data-genero="<?php echo htmlspecialchars($linha["GENERO"]); ?>"
                     data-idioma="<?php echo htmlspecialchars($linha["IDIOMA"]); ?>">
                    <div class="book-cover" style="background: <?php echo $coverColor; ?>">
                    ...
                    <div class="book-body">
                        ...
                        <div class="book-details">
                            <div class="book-detail">
                                ...
                                <span><?php echo htmlspecialchars($linha["AUTOR"] ?: 'Autor não informado'); ?></span>
                            </div>
                            <div class="book-detail">
                                <i class="bi bi-building"></i>
                                <span><?php echo htmlspecialchars($linha["EDITORA"] ?: 'Editora não informada'); ?></span>
                            </div>
                        ...
                        <div class="book-actions">
                            <a href="#" class="btn-action btn-details" onclick="event.stopPropagation(); abrirModalLivro(<?php echo htmlspecialchars(json_encode($linha)); ?>)">
                                <i class="bi bi-eye"></i> Detalhes
                            </a>
                            <a href="/views/User/Loans/solicitar_emprestimo.php?ISBN=<?php echo $ISBN; ?>" class="btn-action btn-reserve" onclick="event.stopPropagation()">
        ...
        <?php } else { ?>
            ...
            <div class="empty-state">
                ...
                <h4 class="empty-text">Nenhum livro encontrado</h4>
                <p class="text-muted mb-3">Não há livros cadastrados no acervo no momento.</p>
            </div>
        <?php } ?>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="info-card">
                            ...
                            <div class="info-content">
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-value" id="modalGenero"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-actions">
                        ...
                        <a href="#" class="btn-modal btn-modal-success" id="modalReserveBtn">
    ...
    <script>
        ...
        function abrirModalLivro(livro) {
            ...
            document.getElementById('modalGenero').textContent = livro.GENERO || 'Não informado';
            document.getElementById('modalGenero').className = livro.GENERO ? 'info-value' : 'info-value empty';
            ...
            if (livro.ISBN) {
                reserveBtn.href = '/views/User/Loans/solicitar_emprestimo.php?ISBN=' + livro.ISBN;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filtrarLivros() {
                ...
                const idiomaFilter = filterIdioma.value;
                ...
                bookCards.forEach(card => {
                    ...
                    if (livro) {
                        ...
                        const idioma = livro.IDIOMA?.toLowerCase() || '';
                        ...
                        const matchGenero = !generoFilter || genero === generoFilter.toLowerCase();
                        const matchIdioma = !idiomaFilter || idioma === idiomaFilter.toLowerCase();
                        
                        if (matchSearch && matchGenero && matchIdioma) {
            ...
            filterGenero.addEventListener('change', filtrarLivros);
            filterIdioma.addEventListener('change', filtrarLivros);
